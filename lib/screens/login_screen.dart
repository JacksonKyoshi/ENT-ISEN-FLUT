...
void fetchJson(username,password,context) async {
   //faire la requête
    ...
    if(response.statusCode == 200) {
      {
        ...
        //write user and password in cache
...
class _LoginPageState extends State<LoginScreen> {
  ...
  void initState()  {
    super.initState();
    //hardcodé pour le moment mais lecture du cache après

    String username = "ronald.weasley" ;
    String passwd = "i<3hermione" ;


    fetchJson(username, passwd, context);
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                ...
                                suffixIcon: IconButton(
                                  icon: Icon(_isPasswordHidden ? Icons.visibility : Icons.visibility_off, size: 28),
                                  onPressed: () {
                                    setState(() {
